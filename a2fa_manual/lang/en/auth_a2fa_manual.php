...
/**
 * Strings for component 'auth_a2fa_manual', language 'en'.
 *
...
$string['auth_a2fa_manualdescription'] = 'This method removes any way for users to create their own accounts.  All accounts must be manually created by the admin user.';
...
$string['pluginname'] = 'A2fa: Manual accounts';
