...
/**
 * Strings for component 'auth_a2fa_ldap', language 'en'.
 *
...
$string['auth_a2fa_ldapdescription'] = 'This method removes any way for users to create their own accounts.  All accounts must be manually created by the admin user.';
